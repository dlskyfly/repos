...
public class BallRedFilter {
	...
	public BallRedFilter(int red1, int red2, int red3, int red4, int red5, int red6) {
		super();
		this.red1 = red1;
		this.red2 = red2;
		this.red3 = red3;
	...
	public BallRedFilter(int red1, int red2, int red3, int red4, int red5, int red6, int interval3, int interval4) {
		super();
		this.red1 = red1;
		this.red2 = red2;
		this.red3 = red3;
